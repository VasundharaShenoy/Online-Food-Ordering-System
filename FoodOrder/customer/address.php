<?php
    ...
    if(isset($_POST)&& !empty($_POST)){
        ...
        $line1=stripslashes(mysqli_real_escape_string($connection,trim($_POST['line1'])));
        $line2=stripslashes(mysqli_real_escape_string($connection,trim($_POST['line2'])));
        $city=stripslashes(mysqli_real_escape_string($connection,trim($_POST['city'])));
        $phone=stripslashes(mysqli_real_escape_string($connection,trim($_POST['phone'])));
