<?php
    ...
    if(isset($_POST)&& !empty($_POST)){
        if(isset($_POST['add'])){
            $itemid=stripslashes(mysqli_real_escape_string($connection,trim($_POST['itemid'])));
            $orderid=stripslashes(mysqli_real_escape_string($connection,trim($_POST['orderid'])));
            $qty=stripslashes(mysqli_real_escape_string($connection,trim($_POST['qty'])));
            $remarks=stripslashes(mysqli_real_escape_string($connection,trim($_POST['remarks'])));
