<?php
    ...
    if(isset($_POST)&& !empty($_POST)){
        $itemname=stripslashes(mysqli_real_escape_string($connection,trim($_POST['itemname'])));
        $category=stripslashes(mysqli_real_escape_string($connection,trim($_POST['category'])));
        $price=stripslashes(mysqli_real_escape_string($connection,trim($_POST['price'])));
        $itemid=stripslashes(mysqli_real_escape_string($connection,trim($_POST['item_id'])));
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">DoorDelights.com</a>
        </div>
